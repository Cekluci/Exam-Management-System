...
class UpdateExamComponent extends Component {
    ...
    componentDidMount() {
        ExamService.getExamById(this.state.id).then( (res) => {
            let exam = res.data;
            this.setState( {examName: exam.examName,
                            location: exam.examLocation,
                            lecturer: exam.lecturer,
                            examDate: exam.examDate,
                            examLimit: exam.examLimit,
                            freeSpace: exam.examFreeSpace })
        })
    }
                    ...
                    <div className='card-body'>
                        <form>
                            ...
                            <div className='row'>
                                ...
                                <div className='col'>
                                    <button type='submit' id='actionButtons' className='btn btn-success float-end' onClick={ this.updateExam }>Save Exam</button>
...
export default withNavigation(UpdateExamComponent);